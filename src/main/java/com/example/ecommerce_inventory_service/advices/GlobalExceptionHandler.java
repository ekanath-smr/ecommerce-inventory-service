...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleInventoryAlreadyExists(
    ...
    public ResponseEntity<ErrorResponseDto> handleActionNotFound(
            InventoryActionNotFoundException ex
    ) {
        return buildErrorResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }
