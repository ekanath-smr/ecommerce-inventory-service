...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleProductNotFound() {
        return buildErrorResponse(HttpStatus.BAD_REQUEST, "Invalid productId, product not found");
    }

    @ExceptionHandler(ProductServiceUnavailableException.class)
    public ResponseEntity<ErrorResponseDto> handleProductServiceUnavailable() {
